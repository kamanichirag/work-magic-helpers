...
const CustomerDetails = () => {
  ...
  return <div className="container mx-auto py-8 px-4">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex space-x-2">
          ...
          {!isEditing ? <AlertDialog>
            ...
            </AlertDialog> : <Button onClick={handleCancel} variant="outline">Cancel</Button>}
      ...
      {isEditing ? <CustomerForm initialData={customer} onSubmit={handleSave} isEditing /> : <>
          <div className="grid grid-cols-1 gap-6 mb-8">
            <CustomerDetailsTabs customer={customer} paymentStatus="pending" onEdit={handleEdit} />
            <PurchaseOrdersList purchaseOrders={customer.purchaseOrders || []} />
          </div>
        </>}
      
      {isEditing && <div className="flex justify-end gap-2 mt-6">
